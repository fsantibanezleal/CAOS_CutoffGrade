...
All notable changes to this product. Format: `X.XX.XXX` (display) — see `cglab.__version__`. Keep `0.x`
...
- Offline `data-pipeline/` (`cglab`): the two data contracts (ingestion + artifact), the named staged
