...
the compact artifact + manifest (CONTRACT 2) and a flat index.json.
    ...
    python -m cglab.pipeline            # all cases
    python -m cglab.pipeline EX02_epidemic --seed 7
"""
...
# data-pipeline/cglab/pipeline.py -> parents[2] = repo root (works under `pip install -e .` too)
